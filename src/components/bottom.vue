  	...
  	<span class="tip">HOW TO FIND</span>
  	  ...
  	  <div class="content">
  	    ...
  	    <dl>
  	      ...
  	      <dd>Mail1: <a href="mailto:a32du@uwaterloo.ca">a32du@uwaterloo.ca</a></dd>
  	      <dd>Mail2: <a href="mailto:283149519du@gmail.com">283149519du@gmail.com</a></dd>
  	    </dl>
  	  </div>
<!--  	  <p v-text="desc"></p>-->
  	</div>
...
<style scoped>
	.bottom{height: auto;width: 100%;margin: 0 auto;background-color: #333333;background: url('../common/images/contact.jpg') no-repeat center top;background-size: cover;padding: 4% 0;}
	...
	.title{padding: 6px 0 10px;font-family: 'Overlock', cursive;color: #fff;font-size: 36px;}
	...
	.content{width:45%;margin:0 auto;background: #f5f5f5;border-radius: 10px; box-shadow: 0 8px 17px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);}
	.content img{width: 40%;height: auto;margin: 30px 0;}
	...
	.content dd a{font-size: 16px;color: #00a78e;}
	.bottom p{font-size: 14px;color: #fff;margin-top: 6%;}
</style>
